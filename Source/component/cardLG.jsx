...
export default function CardLG() {
    ...
    return (
        <Box sx={{ display: 'flex', background: 'linear-gradient(135deg, rgba(91, 228, 155, 0.2), rgba(0, 167, 111, 0.2)) rgb(255, 255, 255)', padding: '30px', alignItems: 'center', gap: 4 }}>
            <Box sx={{ display: 'flex', justifyContent: 'start', flexWrap: 'wrap', flexDirection: 'column' }}>
                <Typography sx={{ color: 'rgb(0, 75, 80)', fontSize: '24px', fontWeight: '700' }} align='left'>
                    Welcome back 👋<br></br>
                    Jaydon Frankie
                </Typography>
                <Typography sx={{ color: 'rgb(0, 75, 80)', fontSize: '14px', fontWeight: '100', margin: '1.25rem 0', width: '90%' }} align='left'>
